...
(define SnapCreate (meep-time-sink-SnapCreate))
(define SnapOutput (meep-time-sink-SnapOutput))
(define SnapComm (meep-time-sink-SnapComm))
(define Nf2ffCalc (meep-time-sink-Nf2ffCalc))
(define Nf2ffComm (meep-time-sink-Nf2ffComm))
(define Nf2ffOutput (meep-time-sink-Nf2ffOutput))
(define ModeVolCalc (meep-time-sink-ModeVolCalc))
